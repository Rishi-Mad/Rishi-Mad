...
**Tech Stack**: React · TypeScript · Python · Vector DB · LLMs

**Links**: 
- 🔗 [Repo](https://github.com/ram-tewari/neo-alexandria)

<details>
  <summary><b>Key Features</b></summary>

- **Smart Organization**: Automatically categorize and tag your knowledge base
- **Semantic Search**: Find information using natural language queries
- **Knowledge Graph**: Visualize connections between concepts
- **AI Insights**: Get summaries and insights from your collected knowledge
</details>
...
**Tech Stack**: Flask · React · TypeScript · Tailwind · T5/BLIP · SQLite · Vite

**Links**: 
- 🔗 [Repo](https://github.com/Rishi-Mad/Study-Pal)

<details>
  <summary><b>Features</b></summary>

- **Smart Summarization**: T5-powered text summarization with keyword extraction
- **Visual Q&A**: BLIP model for answering questions about diagrams and equations
- **Flashcards**: Spaced repetition system for optimal retention
...
- **Custom Extensions**: Support for custom RISC-V instructions
- **Debug Interface**: Step-through execution and register inspection
</details>
...
**Tech Stack**: Python · MediaPipe · OpenCV · React

**Links**: 
- 🔗 [Repo](https://github.com/Rishi-Mad/Fit-Friend)

<details>
  <summary><b>How It Works</b></summary>

1. **Pose Detection**: MediaPipe detects 33 body landmarks in real-time
2. **Exercise Recognition**: Automatically identifies exercise type from movements
3. **Form Analysis**: Computes joint angles and scores form quality
4. **Feedback Generation**: Provides personalized recommendations for improvement
5. **Progress Tracking**: Downloadable workout reports with key frames
</details>
